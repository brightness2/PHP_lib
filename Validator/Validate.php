...
/*
 * @Author: Brightness
 * @Date: 2022-03-29 15:45:30
 * @LastEditors: Brightness
 * @LastEditTime: 2022-03-30 09:11:52
 * @Description:  通用验证器，迁移于thinkphp5
 */

    /* 依赖的类
    * SplFileObject
    * Validator_ValidateRule
    */
    /**
     * 验证器类
     */
    class Validator_Validate
    {
        ...
        public function check($data, $rules = [], $scene = '')
        {
            ...
            foreach ($rules as $key => $rule) {
                ...
                } elseif ($rule instanceof Validator_ValidateRule) {
                    //  验证因子
        ...
        public function checkRule($value, $rules)
        {
            ...
            } elseif ($rules instanceof Validator_ValidateRule) {
                $rules = $rules->getRule();
