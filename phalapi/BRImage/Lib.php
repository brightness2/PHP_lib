...
/*
 * @Author: Brightness
 * @Date: 2022-04-02 13:49:29
 * @LastEditors: Brightness
 * @LastEditTime: 2022-04-02 13:49:29
 * @Description:  图像处理工具
*/
    ...
    public function __construct($type = self::IMAGE_GD, $imgname = null) {
        ...
        switch ($type) {
            case self::IMAGE_GD:
                ...
                $class = BRImage_Driver_Gd::class;
                break;
            case self::IMAGE_IMAGICK:
                // $class = 'PhalApi\Image\Driver\Imagick';
                $class = BRImage_Driver_Imagick::class;
                break;
            default:
                throw new PhalApi_Exception_BadRequest('不支持的图片处理库类型', 1);
        }
