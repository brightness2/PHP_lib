...
/*
 * @Author: Brightness
 * @Date: 2022-04-02 14:37:25
 * @LastEditors: Brightness
 * @LastEditTime: 2022-04-02 14:37:25
 * @Description:  
*/

class BRImage_Driver_Imagick
{
    /* 驱动相关常量定义 */
    ...
    public function open($imgname) {
        ...
        // $this->img = new BRImage_Driver_Imagick(realpath($imgname));
    ...
    public function text($text, $font, $size, $color = '#00000000', $locate = self::IMAGE_WATER_SOUTHEAST, $offset = 0, $angle = 0) {
        ...
        if (!is_file($font)) {
            throw new PhalApi_Exception_BadRequest('不存在的字体文件：{$font}', 1);
        }
