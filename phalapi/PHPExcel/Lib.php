...
class PHPExcel_Lib {
    ...
    public $PHPExcel;#PHPExcel实例
    public $ExcelObj;#打开的excel文件对象
    public $handle;#操作句柄
    ...
    {
        if(!$this->ExcelObj){
            throw new PhalApi_Exception_BadRequest('The excel file has not been imported');
        }
    ...
    /**
     * 获取操作句柄
     * 具体操作方法 查看 PHPExcel_Handle 类
     * @return PHPExcel_Handle
     */
    public function getHandle()
    {
       ...
       return new PHPExcel_Handle($this->ExcelObj);
    }
    ...
    public function exportExcel($fileName, $data, $headArr) {
        ...
        $objWriter = \PHPExcel_IOFactory::createWriter($objPHPExcel, PHPExcel_Lib::getExcelType($fileName));
